...
function validateResource ({
  ...
  const pathToUndefinedProp = getPathToUndefinedProperty(resource)
  if (pathToUndefinedProp) {
    throw new Error(`undefined property values are not allowed: ${pathToUndefinedProp}`)
  }
...
function getPathToUndefinedProperty (obj) {
  let path
